...
We get a warning plus the overall balance, which shows 2 more moles of C and O and 4 of H on the product side than reactant side (see negative values).
...
We can find the one we want in the error message, where they are listed in `acceptor donor` pairs: `'NO3- N2'`.
...
```{r}
micstoich(donor = 'H2', acceptor = 'CO2', fs = 0.1, order = 'decreasing')
micstoich(donor = 'H2', acceptor = 'CO2', fs = 0.1, order = 'increasing')
micstoich(donor = 'H2', acceptor = 'CO2', fs = 0.1, order = 'alphanum')
```
...
# More information
For more on the micstoich package, see <>.
